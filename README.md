...
Building interactive web applications requires a strong understanding of how the DOM updates dynamically based on user actions.  

This project aims to:
- Simulate a real-world social media feed
- Practice dynamic rendering of posts
- Handle user interactions such as likes and comments
- Manage application state without a backend
...
### 💾 Persistent Storage
- Uses **LocalStorage** to persist posts, likes, and comments
- Data remains available after page refresh

### 📱 UI & UX
- Responsive grid-based feed layout
